...
class BooksFixtures extends Fixture
{
    public function load(ObjectManager $manager)
    {
       ...
       $book-> setTitle("A Visit From The Goon Squad")
            ...
            ->setDescription("A Visit from the Goon Squad is a book about the interplay of time and music, about survival, about the stirrings and transformations set inexorably in motion by even the most passing conjunction of our fates.")
       ...
       $book-> setTitle("Gone Girl")
            ...
            ->setGenre("Thriller")
            ->setDescription("Gone Girl's themes include dishonesty, the devious media, the unhappiness that comes with a troubled economy, and the superficial nature of appearance.")
       ...
       $book-> setTitle("Freedom")
            ...
            ->setDescription("The novel follows the lives of the Berglund family, particularly the parents Patty and Walter, as their lives develop and then their happiness falls apart.")
